...
class FiniteAlgebraSpec:
    ...
    def from_products(
        ...
        Unspecified products are zero, except products with the unit basis element,
        which are filled as identity products unless explicitly overridden.
        """
...
def upper_triangular_semidirect_algebra() -> FiniteAlgebraSpec:
    ...
    The basis models the upper-triangular algebra generated by a projection `p`
    and radical element `n`: p^2=p, p*n=n, n*p=0, n^2=0.
    """
